...
function StepIndicator({ step, currentStep, onClickStep, disableStepIndicators }: StepIndicatorProps) {
    ...
    return (
        <motion.div onClick={handleClick} className="step-indicator" animate={status} initial={false}>
            <motion.div
                variants={{
                    inactive: { scale: 1, backgroundColor: '#f1f5f9', color: '#94a3b8', border: '2px solid transparent' },
                    active: { scale: 1, backgroundColor: '#0d9488', color: '#fff', border: '2px solid #0d9488' },
                    complete: { scale: 1, backgroundColor: 'transparent', color: '#0d9488', border: '2px solid #0d9488' }
                }}
